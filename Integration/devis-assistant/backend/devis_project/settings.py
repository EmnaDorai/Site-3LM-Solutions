...
SECRET_KEY = 'django-insecure-*g9crg(o)z90%8rydojbwuajgk@zns$et*@20@gd@4i&tvjvgn'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',   # ← ajoute cette ligne en premier
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # ton frontend Next.js en dev
]

# Configuration email
EMAIL_BACKEND = os.getenv('EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', '3lmsolutions@gmail.com')
